...
export default function SuperAdminPanel({ onLogout }: { onLogout?: () => void }) {
    ...
    const SkeletonMetricCard = () => <View style={[styles.metricCard, { width: (width - ms(54)) / 2 }]}>
        <SkeletonItem width={ms(36)} height={ms(36)} borderRadius={ms(12)} />
        <SkeletonItem width="50%" height={ms(10)} borderRadius={ms(4)} style={{ marginTop: ms(8) }} />
        <SkeletonItem width="35%" height={ms(22)} borderRadius={ms(6)} style={{ marginTop: ms(4) }} />
        <SkeletonItem width="60%" height={ms(9)} borderRadius={ms(3)} style={{ marginTop: ms(4) }} />
    </View>;
