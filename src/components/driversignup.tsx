...
/* ─────────────────────────── Assets ─────────────────────────── */
const HERO_VIDEO = require("../../assets/expo.icon/Assets/driver-navigation-animation-gif-download-9531985.mp4");
...
export type DriverSignupData = Record<FieldKey, string>;
...
/* ═══════════════════════════ Ultra Premium Big Field with Shaking ═══════════════════════════ */
function BigField({
...
/* ═══════════════════════════ Main Page ═══════════════════════════ */
export default function DriverSignupPage({ onBack, onSubmit }: DriverSignupPageProps) {
    ...
    /* ── Form State ── */
    const [data, setData] = useState<DriverSignupData>(EMPTY);
    ...
    const setField = (key: FieldKey, raw: string) => {
        const isUpper = key === "busNumber";
        let v = isUpper ? raw.toUpperCase().replace(/[^A-Z0-9-]/g, "") : raw;
        setData((d) => ({ ...d, [key]: v }));
