        ...
        <>
            ...
            <Card style={{ marginTop: ms(16) }}>
                <View style={{ flexDirection: "row", alignItems: "center", gap: 12 }}>
                    <View style={{ width: ms(48), height: ms(48), borderRadius: ms(16), backgroundColor: ACCENT_SOFT, alignItems: "center", justifyContent: "center", overflow: "hidden", borderWidth: 1, borderColor: "#F5E6A3" }}>
                        <Image source={schoolBusIcon} style={{ width: "90%", height: "90%" }} resizeMode="contain" />
                    </View>
                    <View style={{ flex: 1 }}>
            ...
            {BUSES.map((bus) => (
                <Card key={bus.id} style={{ marginBottom: ms(10), padding: ms(13) }}>
                    <View style={{ flexDirection: "row", alignItems: "center", gap: 12 }}>
                        <View style={{ width: ms(40), height: ms(40), borderRadius: ms(14), backgroundColor: bus.assigned ? ACCENT_SOFT : PAGE_BG, alignItems: "center", justifyContent: "center", overflow: "hidden", borderWidth: 1, borderColor: bus.assigned ? "#F5E6A3" : BORDER }}>
                            <Image source={schoolBusIcon} style={{ width: "85%", height: "85%" }} resizeMode="contain" />
                        </View>
                        <View style={{ flex: 1 }}>
